 ...
 🚀 ReportX - Advanced Reporting & Data Management Platform
...
- **Multi-Format Exporting**: 
  - 📥 **Excel**: High-fidelity `.xlsx` exports using `ExcelJS`.
  - 📄 **PDF**: Clean, professional PDFs with `jsPDF` and `html2pdf`.
...
```text
src/
├── admin/          # Admin-specific pages, components, and services
├── portal/         # User-facing portal, reports, and layouts
